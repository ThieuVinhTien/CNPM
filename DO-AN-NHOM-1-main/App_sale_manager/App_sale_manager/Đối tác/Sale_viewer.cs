...
namespace App_sale_manager
{
    public partial class Sale_viewer : Form
    {
        ...
        public Sale_manager Sale_get(DataGridViewRow A)
        {
            ...
            {
                case "TPK":
                    SaleCondition = "Thực phầm khô";
                    break;
                case "MAK":
                    SaleCondition = "Quần - áo em bé";
                    break;
                case "DGD":
                    SaleCondition = "Đồ gia dụng";
                    break;
                case "RC":
                    SaleCondition = "Rau củ";
                    break;
                case "BN":
                    SaleCondition = "Bò nhập";
                    break;
                case "G45":
                    SaleCondition = "Gà 45kg";
                    break;
                case "MP":
                    SaleCondition = "Mỹ Phẩm";
                    break;
                case "DG":
                    SaleCondition = "Dầu gội";
                    break;
            }
